...
14. [security-audit-2026-08-26.md](security-audit-2026-08-26.md) — release security, privacy, dependency, and license evidence.
...
17. [local-data-lifecycle.md](local-data-lifecycle.md) — backup, offline restore, reset, migration, and uninstall recovery.
18. [roadmap.md](roadmap.md) — implementation sequence and current status.
